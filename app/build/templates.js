angular.module('calcuratorusApp').run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put('calculator/views/conversion_results.html',
        "<div><div>Roman Numeral Value</div><div class=container><div class=\"row keypad-row\"><div ng-bind=convertedText class=\"displayContainer converted-results\"></div></div></div></div>"
    );

    $templateCache.put('calculator/views/numeric/numeric_calculator.html',
        "<div class=jumbotron ng-controller=NumericToRomanCtrl><div><converted-results-directive class=pad></converted-results-directive></div><div class=displayContainer><div class=pad><numeric-calculator numeric-display class=typeNumber placeholder=\"0\"></div></div><div class=\"container keypadContainer\"><div class=row><numeric-calculator numeric-keypad-directive=\"\" class=col-sm-10></numeric-calculator><numeric-calculator function-keypad-directive class=col-sm-2></numeric-calculator></div></div></div>"
    );
